...
class CertificateUtilTest {
    ...
    void testFingerprintSha1And256() throws Exception {
        ...
        String expected1 = de.morihofi.acmeserver.utils.conversion.HexConverter.bytesAsHexString(md1.digest(cert.getEncoded()));
        String expected256 = de.morihofi.acmeserver.utils.conversion.HexConverter.bytesAsHexString(md256.digest(cert.getEncoded()));
