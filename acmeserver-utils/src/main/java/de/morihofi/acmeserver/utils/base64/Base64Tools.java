package de.morihofi.acmeserver.utils.base64;
...
public class Base64Tools {
    ...
    /**
     * Encodes a string into a Base64 URL-safe representation without padding.
     *
     * @param stringToEncode The string to encode.
     * @return The Base64 URL-safe encoded string.
     */
    public static @NonNull String encodeBase64URL(@NonNull String stringToEncode) {
     ...
     */
    public static @NonNull String base64UrlEncode(byte[] data) {
