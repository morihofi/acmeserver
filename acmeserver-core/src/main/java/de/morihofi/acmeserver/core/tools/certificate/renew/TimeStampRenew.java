    ...
    public static CertificateRenewScheduler.CertificateData renew(KeyPair tsaKeyPair,
        ...
        X509Certificate renewed = X509Generator.generate(
                X509Generator.Request.builder()
                        ...
                        .issuerKeyPair(si.getCryptoStoreManager().getCerificateAuthorityKeyPair(si.getRootCa()))
                        .issuerCertificate(si.getCryptoStoreManager().getCerificateAuthorityX509Certificate(si.getRootCa()))
                        .ownKeyPair(tsaKeyPair)
                        .build()
        );
        X509Certificate rootCert = si.getCryptoStoreManager().getCerificateAuthorityX509Certificate(si.getRootCa());
