...
/**
 * Represents the value part of a table entry in a web user interface, encapsulating the actual
 * data to be displayed and its type. The data can be presented as plain text or as a hyperlink,
 * depending on the specified {@link VALUE_TYPE}. This class allows for a flexible representation
 * of table values, facilitating the rendering of different types of content within table cells.
 */
public class TableValue {
    ...
    /**
     * Enumerates the possible types of values that can be represented, allowing for differentiation
     * between plain text values and hyperlinks.
     */
    ...
    /**
     * Constructs a new TableValue with the specified content and value type. This constructor allows
     * for the explicit specification of the value's type, facilitating the appropriate rendering of
     * the value in the UI.
     *
    ...
    /**
     * Constructs a new TableValue with the specified content, defaulting to a value type of {@code NONE}.
     * This constructor is convenient when the value is plain text and does not require special rendering
     * as a hyperlink.
     *
