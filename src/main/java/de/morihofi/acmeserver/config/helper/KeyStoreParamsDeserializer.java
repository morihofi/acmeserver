...
/**
 * Deserializer for {@link KeyStoreParams} objects.
 * This class implements the {@link JsonDeserializer} interface to provide custom deserialization
 * for different types of KeyStore parameters, such as PKCS11 and PKCS12.
 */
public class KeyStoreParamsDeserializer implements JsonDeserializer<KeyStoreParams> {

    /**
     * Deserializes a JSON element into an appropriate {@link KeyStoreParams} subclass.
